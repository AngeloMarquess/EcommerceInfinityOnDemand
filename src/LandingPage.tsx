...
function LandingPage() {
  ...
  const handleWhatsappChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (value.length > 11) value = value.slice(0, 11); // Limita a 11 números (DDD + 9 dígitos)
      ...
      <section className="hero">
        <div className="container hero-container">
          ...
          <div className="hero-stats delay-3" style={{ gridColumn: '1 / -1', width: '100%', justifyContent: 'center' }}>
            <div className="stat">
              <h3>+150%</h3>
              <p>Aumento<br />em conversões</p>
            </div>
            <div className="stat">
              <h3>R$ 50M+</h3>
              <p>Gerenciados<br />em Ads</p>
            </div>
            <div className="stat">
              <h3>99</h3>
              <p>Negócios<br />Lançados</p>
            </div>
            <div className="stat">
              <h3>210</h3>
              <p>Projetos<br />Completos</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          ...
          <div className="services-grid">
            {[
              {
                icon: <Target size={32} />,
                title: 'Tráfego Pago p/ E-commerce',
                desc: 'Campanhas de Google Ads e Meta Ads desenhadas especificamente para converter produtos e escalar seu ROAS.',
                color: 'var(--primary)',
                bgStyle: 'rgba(0, 255, 135, 0.1)'
              },
              {
                icon: <ShoppingCart size={32} />,
                title: 'Otimização de Conversão (CRO)',
                desc: 'Análise UX e melhorias contínuas no seu site para transformar mais visitantes em clientes pagantes.',
                color: 'var(--primary)',
                bgStyle: 'rgba(0, 255, 135, 0.1)'
              },
              {
                icon: <Smartphone size={32} />,
                title: 'Desenvolvimento de Apps & Lojas',
                desc: 'Criação de ecossistemas completos e rápidos focados na melhor experiência de compra para o usuário.',
                color: 'var(--primary)',
                bgStyle: 'rgba(0, 255, 135, 0.1)'
              },
              {
                ...
                desc: 'Designs criativos e personalizados para fortalecer sua marca e engajar seu público.',
                color: '#eab308',
              ...
              },
              {
                ...
                desc: 'Otimizamos processos e interações com automações que aumentam a eficiência e melhoram a experiência do cliente.',
                color: '#00ff87',
                bgStyle: 'rgba(0, 255, 135, 0.1)'
              },
              {
                ...
                desc: 'Atendimento rápido e eficiente 24/7 para impulsionar seu negócio e melhorar a experiência do cliente.',
                color: '#ef4444',
          ...
          <div className="portfolio-grid">
            {[
              ...
              <div key={idx} className={`portfolio-item glass ${item.isHighlight ? 'item-highlight' : ''}`}>
                <div className="portfolio-img-placeholder" style={item.isHighlight && !item.image ? { background: 'linear-gradient(135deg, rgba(0,255,135,0.1) 0%, rgba(0,0,0,0.8) 100%)' } : {}}>
                  {item.image ? (
                    <img src={item.image} alt={item.title} className="portfolio-cover-img" />
                  ) : (
                    <Globe size={48} className={item.isHighlight ? "text-gradient" : "text-muted opacity-50"} />
                  )}
                ...
                <div className="portfolio-info">
                  ...
                  <a href={item.link} target={item.link !== '#' ? "_blank" : undefined} rel="noreferrer" className="portfolio-link">
          ...
          <div className="trust-badges-flex">
            <div className="trust-badge nuvemshop-badge">
              <div className="n-logo-text">
                <Cloud size={20} /> nuvemshop
              </div>
              <div className="n-partner-text">
                Silver<br />Partner
              </div>
            </div>
